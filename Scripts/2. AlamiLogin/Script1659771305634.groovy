...
WebUI.click(findTestObject('Object Repository/Page_Alami - Dashboard/svg'))

WebUI.click(findTestObject('Object Repository/Page_Alami - Dashboard/div_Keluar'))
